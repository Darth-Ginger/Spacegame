...
namespace Gamelogic.Extensions
{
	...
	public sealed class ScreenshotTaker : Singleton<ScreenshotTaker>
	{
		...
		private Dictionary<GameObject, bool> stateOfSreenshotOnlyObjects;
		...
		{
			stateOfSreenshotOnlyObjects = new Dictionary<GameObject, bool>();

			foreach (var screenshotOnlyObject in screenshotOnlyObjects)
			{
				stateOfSreenshotOnlyObjects.Add(screenshotOnlyObject, screenshotOnlyObject.activeSelf);
		...
		{
			foreach (var stateOfScreenshotOnlyObject in stateOfSreenshotOnlyObjects)
			{
		...
		private void RestoreScreenshotDirtyObjecst()
		{
