...
namespace ScriptableObjectWindow {
public class ScriptableObjectWindow : EditorWindow {
    ...
    public static void Init() {
        ...
        w.titleContent = new GUIContent("Context", AssetDatabase.LoadAssetAtPath<Texture2D>("Packages/com.beetlecircus.scriptableobjectwindow/Icons/TitleBar.png"));
    }
    ...
    private void OnGUI() {
        ...
        var searchStyle = GUI.skin.FindStyle("ToolbarSearchTextField");
#else
...
#if UNITY_2021_3_OR_NEWER
                var tp = GUI.skin.FindStyle("ToolbarSearchTextFieldPopup");
#else
    ...
    private string ToolbarSearchField(int id, Rect position, string text) {
        ...
        position2.width -= 14f;
#if UNITY_2021_3_OR_NEWER
        text = DoTextField(id, position2, text, GUI.skin.FindStyle("ToolbarSearchTextFieldPopup"));
#else
        ...
        position3.width = 14f;
#if UNITY_2021_3_OR_NEWER
        var buttonStyle = (!(text != "")) ? GUI.skin.FindStyle("ToolbarSearchCancelButtonEmpty") : GUI.skin.FindStyle("ToolbarSearchCancelButton");
#else
